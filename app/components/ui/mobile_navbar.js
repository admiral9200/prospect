...
const navigation = [
  ...
  { name: 'Suggestions', href: '#', icon: BeakerIcon, current: false },
  { name: 'My Contacts', href: '/contacts', icon: Cog6ToothIcon, current: false },
  { name: 'My Campaign', href: '/campaigns', icon: Cog6ToothIcon, current: false },
...
export default function MobileNavbar({ sidebarOpen, setSidebarOpen }) {
                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                            ...
                            {navigation.map((item) => (
                              <li key={item.name}>
                                ...
                                >
                                  <item.icon
                                    className={classNames(
                                      item.current ? 'text-white' : 'text-black group-hover:text-white',
                                      'h-6 w-6 shrink-0'
                                    )}
                                    aria-hidden="true"
                                  />
                        ...
                        <li className="mt-auto">
                          <a
                            href="#"
                            className="group -mx-2 flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-indigo-200 hover:bg-indigo-700 hover:text-white"
                          >
                            <Image
                              src={'/logout.svg'}
                              width={30}
