      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs leading-6 text-gray-500">Documentation</div>
          </div>
          <div className="mt-1 border-t border-gray-200 pt-5">
            <div className="flex items-baseline gap-2">
              <div className="text-sm text-gray-900">
                ...
                model, but will also be: Data-aware: connect a language model to
                other sources of data Agentic: allow a language model to
                interact with its environment The LangChain framework is
                designed around these principles. This is the Python specific
                portion of the documentation. For a purely conceptual guide to
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Add one or multiple links to turn any knowledge base into AI
              Chatbot and integrate it to your website within minutes.
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <Button href="#">Create your chatbot</Button>
              <Button
