      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-gray-200 pb-12 pt-8 md:flex-row-reverse md:justify-between md:pt-6">
          {/*  <TextField
            ...
            />*/}
          <Link href="https://join.slack.com/t/prospcommunity/shared_invite/zt-1zrpgmze8-BfkB3uXuVFTVxRXkTxPPBw">
            <Button className="ml-4 flex-none bg-violet-600 hover:bg-violet-500">
