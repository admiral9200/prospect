...
import Container from './sequence-builder-modal'

const SequenceBuildModal = ({ setOpen, open, setAction, setCondition }) => {
            ...
            <Dialog as="div" className="relative z-30" initialFocus={cancelButtonRef} onClose={setOpen}>
                ...
                <div className="fixed inset-0 z-8 w-full h-full overflow-y-auto">
                    <div className="flex min-h-full w-full items-center justify-center p-4 text-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-[25px] shadow-xl transition-all w-[1200px] bg-white">
                                <div className='w-full min-h-[370px] max-h-[370px]'>
                                    <Container
                                        setOpen={setOpen}  
                                        setAction={setAction}
...
export default SequenceBuildModal;