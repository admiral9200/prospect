...
import linkedinPreviewExportModule from '@/app/components/campaign/linkedinPreviewExportModule';
...
const CampaignSetup: React.FC = () => {
  ...
  const modules = [
    {
      id: 1,
      title: t('export_campaign_module_title_id_1'),
      description: t('export_campaign_module_desc_id_1'),
      component: LinkedInModule,
      step: 1,
    },
    {
      id: 2,
      title: t('export_campaign_module_title_id_2'),
      description: t('export_campaign_module_desc_id_2'),
      component: PromptModule,
      step: 1,
    },
    {
      id: 3,
      title: t('export_campaign_module_title_id_3'),
      description: t('export_campaign_module_desc_id_3'),
      component: ProfileFinderModule,
      step: 2,
    },
    {
      id: 4,
      title: t('export_campaign_module_title_id_4'),
      description: t('export_campaign_module_desc_id_4'),
      component: uploadCsvProfileModule,
      step: 2,
    },
    {
      id: 5,
      title: t('export_campaign_module_title_id_5'),
      description: t('export_campaign_module_desc_id_5'),
      component: linkedinPreviewExportModule,
      step: 3,
    },
  ...
  const runCampaign = async () => {
    ...
    try {
      const response = await fetch('/api/export-campaigns', requestOptions);
  ...
  const nextPage = () => {
    if (currentPage < 3) { // Maximum of 3 pages
      ...
      router.push(`${lang}/export-campaign-setup?id=${campaignId}&step=${currentPage + 1}`)
    }
  };
  ...
  const getHeaderContent = (step: number) => {
    switch (step) {
      ...
      case 3:
        return { title: t('export_campaign_header_title_step_3'), description: t('export_campaign_header_desc_step_3') };
      default:
